...
$sql_service = "SELECT * FROM tb_service WHERE shop_id = $shop_id ORDER BY id DESC";
...
<body>
    ...
    <section class="review" id="review">
        ...
        <div class="swiper review-slider">
            ...
            <div class="swiper-wrapper" height="auto">
                ...
                <div class="swiper-slide box3" height="auto">
                    <img src="../photo/ตู้ซักผ้า2.jpg" alt="">
                    <h3>ชื่อลูกค้า</h3>
                    <div class="stars">
                        <i class='bx bxs-star'></i>
                    ...
                    <tbody>
                        ...
                        if ($result_service->num_rows > 0) {
                            ...
                            while ($row = $result_service->fetch_assoc()) {
                                ...
                                echo "<td>" . htmlspecialchars($row['details_sevice']) . "</td>"; // Service details
    ...
    <script>
        ...
        function viewmessenger(serviceId) {
            ...
            xhr.onload = function() {
                if (this.status === 200) {
                    const data = JSON.parse(this.responseText); // สมมติว่าข้อมูลที่ส่งกลับมาเป็น JSON
