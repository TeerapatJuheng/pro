    ...
    <div class="container">
        ...
        <div class="font">
            ...
            <select class="form-select" aria-label="Default select example">
                ...
                <option value="2">ออเดอร์</option>
                <option value="3">บริการ</option>
            </select>
            <br>
            <div class="date">
                <label for="text" type="date">วันที่เริ่มต้น - สิ้นสุด</label>
                <input type="date"><span> - </span>
                <input type="date">
            </div>
            <div class="from_group">
                <label for="time_1" type="time">เวลาเริ่มต้น - สิ้นสุด</label>
                <input type="time" name="time" id="time"> <span> - </span>
                <input type="time" name="time" id="time">
            </div>

            <button class="dlp">Download PDF</button>
